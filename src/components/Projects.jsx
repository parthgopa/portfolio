...
const projectsData = [
  {
    ...
    // image: Project1,
    description:
      "A cutting-edge educational platform that empowers both learners and tutors with AI-driven features like lesson planning, summarization, and exercise generation.",
  ...
  },
  {
    ...
    // image: Project2,
    description:
      "An AI-powered tool streamlining critical workflows for Company Secretaries with modules for compliance calendar, secretarial audit,reply to notices, and regulatory updates.",
    techStack: [
      "React JS",
      "AI API Integration",
      "Prompts Engineering",
  ...
  },
  {
    ...
    // image: Project3,
    description:
      "A health analysis tool using Python that analyzes facial features frame by frame through OpenCV and Google's Gemini AI, solving real-world lab testing problems at reduced costs.",
...
const Projects = () => {
  return (
    <div
      name="projects"
      className="w-full text-gray-300 bg-gradient-to-b from-[#112240] to-[#0a192f] py-4"
    >
          ...
          {projectsData.map((project, index) => (
            ...
            >
              <div className="h-28 bg-gradient-to-br from-emerald-500/20 to-blue-600/20 flex items-center justify-center border-b border-emerald-400/20">
                <h3 className="text-2xl font-bold text-emerald-400 text-center">
                  {project.title}
                </h3>
              </div>
