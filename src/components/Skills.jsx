...
import { SiJavascript, SiMongodb, SiTensorflow } from "react-icons/si";
...
const skills = [
  ...
  {
    icon: <img src="/brain.png" className="w-20 h-20" />,
    name: "Neural Networks",
  },
  { icon: <FaReact className="text-blue-400" size={50} />, name: "React" },
  {
    icon: <FaReact className="text-blue-400" size={50} />,
    name: "React Native",
  },
  {
    icon: <SiTensorflow className="text-red-500" size={50} />,
    name: "TensorFlow",
  },
  {
  ...
  {
    icon: <FaPython className="text-blue-500" size={50} />,
    name: "Python (Flask)",
  },
  ...
  {
    icon: <img src="/project.png" className="w-20 h-20" />,
...
const Skills = () => {
  return (
    <div
      name="skills"
      className="w-full bg-gradient-to-b from-[#0a192f] to-[#112240] text-gray-300 py-2"
    >
