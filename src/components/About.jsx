      ...
      <div className="max-w-[1200px] mx-auto px-6 py-6 w-full ">
        ...
        >
          ...
          <div className="md:col-span-8 text-lg text-gray-300 leading-relaxed flex flex-col justify-center">
            <p>
              Hello! I'm a Computer Science and Engineering graduate from The
              Maharaja Sayajirao University of Baroda with a strong passion for
              AI and Web Development. I'm specialized in React JS, Flask, and
              the development of chatbots.
            </p>
            <br />
            <p>
              I'm currently working as a Software Developer Intern at SANRUSHA
              in North Carolina, where I've developed a subscription-based
              business model with PayPal payment integration. I'm passionate
              about leveraging AI solutions to address real-world problems and
              always keen to explore AI tools and technologies for innovative
