...
const Hero = () => {
  return (
    <div
      name="home"
      className="w-full mt-18 pt-18 bg-gradient-to-b from-[#0a192f] to-[#112240] relative"
    >
      {/* Container */}
      <motion.div
      ...
      >
        <p className="text-emerald-400 text-xl font-semibold tracking-wider">
          Hi, my name is
        </p>
        ...
        <p className="text-gray-300 py-4 max-w-[700px] text-lg leading-relaxed">
          I'm a Computer Science graduate from The Maharaja Sayajirao University
          of Baroda, specializing in AI and Web Development. I'm passionate
        ...
        <div className="flex space-x-6 mt-4">
          ...
          <a
            href="https://github.com/parthgopa"
            target="_blank"
            rel="noopener noreferrer"
            className="text-gray-300 hover:text-emerald-400 transition-colors duration-300"
          >
